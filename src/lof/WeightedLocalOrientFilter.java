...
public class WeightedLocalOrientFilter {
   ...
   */
  public WeightedLocalOrientFilter(double sigma, EigenTensors2 t2, float[][] s2) {
    this(sigma,sigma,sigma,t2,s2);
  }

  public WeightedLocalOrientFilter(double sigma, EigenTensors3 t3, float[][][] s3) {
    this(sigma,sigma,sigma,t3,s3);
  }
   ...
   */
  public WeightedLocalOrientFilter(double sigma1, double sigma2, EigenTensors2 t2, float[][] s2) {
    this(sigma1,sigma2,sigma2,t2,s2);
  }

  public WeightedLocalOrientFilter(double sigma1, double sigma2, EigenTensors3 t3, float[][][] s3) {
    this(sigma1,sigma2,sigma2,t3,s3);
  }
   ...
   */
  public WeightedLocalOrientFilter(
    double sigma1, double sigma2, double sigma3, EigenTensors2 t2, float[][] s2) 
  {
    int n2 = s2.length;
    int n1 = s2[0].length;
    float[][] au = new float[n2][n1];
    float[][] av = new float[n2][n1];
    _lsSmootheru = new LaplacianSmoother(sigma1,t2,s2,av,s2);
    _lsSmootherv = new LaplacianSmoother(sigma2,t2,au,s2,s2);
    setGradientSmoothing(1.0,t2,s2);
  }

  public WeightedLocalOrientFilter(
    double sigma1, double sigma2, double sigma3, EigenTensors3 t3, float[][][] s3) 
  {
    int n3 = s3.length;
    int n2 = s3[0].length;
    int n1 = s3[0][0].length;
    float[][][] au = new float[n3][n2][n1];
    float[][][] av = new float[n3][n2][n1];
    float[][][] aw = new float[n3][n2][n1];
    _lsSmootheru = new LaplacianSmoother(sigma1,t3,s3,av,aw,s3);
    _lsSmootherv = new LaplacianSmoother(sigma2,t3,au,s3,aw,s3);
    _lsSmootherw = new LaplacianSmoother(sigma3,t3,au,av,s3,s3);
    setGradientSmoothing(1.0,t3,s3);
  }
   ...
   */
  public void setGradientSmoothing(double sigma, EigenTensors2 t2, float[][] s2) {
    setGradientSmoothing(sigma,sigma,sigma,t2,s2);
  }
  public void setGradientSmoothing(double sigma, EigenTensors3 t3, float[][][] s3) {
    setGradientSmoothing(sigma,sigma,sigma,t3,s3);
  }
   ...
   */
  public void setGradientSmoothing(double sigma1, double sigma2, EigenTensors2 t2, float[][] s2) {
    setGradientSmoothing(sigma1,sigma2,sigma2,t2,s2);
  }

  public void setGradientSmoothing(double sigma1, double sigma2, EigenTensors3 t3, float[][][] s3) {
    setGradientSmoothing(sigma1,sigma2,sigma2,t3,s3);
  }
    ...
    double sigma1, double sigma2, double sigma3, EigenTensors2 t2, float[][] s2) 
  {
    ...
    float[][] au = new float[n2][n1];
    float[][] av = new float[n2][n1];
    _lsGradientu = new LaplacianSmoother(sigma1,t2,s2,av,s2);
    _lsGradientv = new LaplacianSmoother(sigma2,t2,au,s2,s2);
  }
    ...
    double sigma1, double sigma2, double sigma3, EigenTensors3 t3, float[][][] s3) 
  {
    ...
    float[][][] av = new float[n3][n2][n1];
    float[][][] aw = new float[n3][n2][n1];
    _lsGradientu = new LaplacianSmoother(sigma1,t3,s3,av,aw,s3);
    _lsGradientv = new LaplacianSmoother(sigma2,t3,au,s3,aw,s3);
    _lsGradientw = new LaplacianSmoother(sigma3,t3,au,av,s3,s3);
  }
    ...
    float[][] el)
  {
    ...
    computeGradient1(x,g1); 
    computeGradient2(x,g2); 
    float[][] gt = copy(g1);
    _lsGradientu.apply(gt,g1);
    gt = copy(g2);
    _lsGradientv.apply(gt,g2);
    ...
    if (_lsSmootheru!=null || _lsSmootherv!=null) {
      float[][] h = (nt>3)?t[3]:new float[n2][n1];
      float[][][] gs = {g11,g22,g12};
      for (float[][] g:gs) {
        if (_lsSmootheru!=null) {
          _lsSmootheru.apply(g,h);
        } else {
          copy(g,h);
        }
        if (_lsSmootherv!=null) {
          _lsSmootherv.apply(h,g);
        } else {
          copy(h,g);
        }
      }
    ...
    float[][][] ep, float[][][] el)
  {
    ...
    computeGradients(x,g1,g2,g3);
    //_lsGradient1.apply(gt,g1);
    //gt = copy(g2);
    //_lsGradient2.apply(gt,g2);
    //gt = copy(g3);
    //_lsGradient3.apply(gt,g3);
    ...
    float[][][] gt = copy(g1);
    _lsGradientu.apply(gt,g1);
    _lsGradientv.apply(g1,gt);
    _lsGradientw.apply(gt,g1);
    gt = copy(g2);
    _lsGradientu.apply(gt,g2);
    _lsGradientv.apply(g2,gt);
    _lsGradientw.apply(gt,g2);
    gt = copy(g3);
    _lsGradientu.apply(gt,g3);
    _lsGradientv.apply(g3,gt);
    _lsGradientw.apply(gt,g3);
    // Gradient products.
    float[][][] g11 = g1;
    float[][][] g22 = g2;
    float[][][] g33 = g3;
    ...
    // Smoothed gradient products comprise the structure tensor.
    if (_lsSmootheru!=null || _lsSmootherv!=null || _lsSmootherw!=null) {
      ...
      for (float[][][] g:gs) {
        ...
        if (_lsSmootherw!=null) {
          _lsSmootherw.apply(g,h);
          copy(h,g);
        }
      }
    }
  ...
  ///////////////////////////////////////////////////////////////////////////
  // private
  private LaplacianSmoother _lsGradientu;
  private LaplacianSmoother _lsGradientv;
  private LaplacianSmoother _lsGradientw;
  private LaplacianSmoother _lsSmootheru;
  private LaplacianSmoother _lsSmootherv;
  private LaplacianSmoother _lsSmootherw;
  ...
  private void computeGradient1(float[][] x, float[][] g1) {
    int n2 = x.length;
    int n1 = x[0].length;
    for (int i2=1; i2<n2-1; ++i2) 
      for (int i1=1; i1<n1-1; ++i1) 
        g1[i2][i1] = 0.5f*(x[i2][i1+1]-x[i2][i1-1]);
    for (int i2=0; i2<n2; ++i2) {
  ...
  private void computeGradient2(float[][] x, float[][] g2) {
    int n2 = x.length;
    int n1 = x[0].length;
    for (int i2=1; i2<n2-1; ++i2) 
      for (int i1=1; i1<n1-1; ++i1) 
        g2[i2][i1] = 0.5f*(x[i2+1][i1]-x[i2-1][i1]);
    for (int i1=0; i1<n1; ++i1) {
       g2[0   ][i1] = x[1   ][i1] - x[0   ][i1];
       g2[n2-1][i1] = x[n2-1][i1] - x[n2-2][i1];
    }
  }

  private void computeGradients(
    final float[][][] x, final float[][][] g1, final float[][][] g2, final float[][][] g3) 
  {
    ...
    Parallel.loop(n3,new Parallel.LoopInt() {
      public void compute(int i3) {
        computeGradient1(x[i3],g1[i3]); 
        computeGradient2(x[i3],g2[i3]); 
      }
    });
    Parallel.loop(n2,new Parallel.LoopInt() {
      public void compute(int i2) {
        float[][] x2i = new float[n3][n1];
        float[][] g2i = new float[n3][n1];
        for (int i3=0; i3<n3; ++i3) 
          x2i[i3] = x[i3][i2];
        computeGradient2(x2i,g2i); 
        for (int i3=0; i3<n3; ++i3) 
          g3[i3][i2] = g2i[i3];
      }
    });
  ...
  private static class LaplacianSmoother {
    LaplacianSmoother(
      double halfWidth, EigenTensors2 t, 
      float[][] au, float[][] av, float[][] s2) 
    {
      _t2  = t; 
      _au2 = au;
      _av2 = av;
      ...
      _scale = hw*(hw+1.0f)/6.0f; 
    }
    LaplacianSmoother(
      double halfWidth, EigenTensors3 t, 
      float[][][] au, float[][][] av, float[][][] aw, float[][][] s3) 
    {
      _t3  = t;
      _au3 = au;
      _av3 = av;
    ...
    public void apply(float[][] f, float[][] g) {
      ...
      _t2.getEigenvalues(au,av);
      _t2.setEigenvalues(_au2,_av2);
      _lsf.applySmoothL(_kmax,f,sf);
      _lsf.apply(_t2,_scale,_s2,sf,g);
      _t2.setEigenvalues(au,av);
    }
    public void apply(float[][][] f, float[][][] g) {
      int n3 = f.length; 
      int n2 = f[0].length; 
      ...
      _s3 = new float[n3][n2][n1];
      _s3 = add(_s3,1.0f);
      _t3.getEigenvalues(au ,av ,aw );
      _t3.setEigenvalues(_au3,_av3,_aw3);
      _lsf.applySmoothL(_kmax,f,sf);
      _lsf.apply(_t3,_scale,_s3,sf,g);
      _t3.setEigenvalues(au,av,aw);
    }
