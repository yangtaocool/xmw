...
import vec.*;
/**
 * Surface refinement using the active surface method
 * Slightly adjust a surface to align with peaks or troughs
 * @author Xinming Wu
 * @version 2013.12.08
 */
public class SurfaceRefine {
  ...
  private static void computeFext(
    float[][] scale,float[][] surf, float[][][] Eext, 
    float h,float step,float[][] b)
  {
    int n3 = Eext.length;
